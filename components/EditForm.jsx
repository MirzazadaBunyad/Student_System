  ...
  return (
    ...
    >
      ...
      <div className="w-full flex justify-between">
        <button
          type="submit"
          className="w-full text-center text-[20px] transition-[.3s] py-3 rounded bg-green text-blue-500 hover:text-white hover:bg-blue-700 focus:outline-none my-1"
        >
          Update
        </button>
        ...
        <button
          ...
          type="button"
          className="w-full text-center py-3 rounded bg-green transition-[.3s] text-[20px] text-red-500 hover:text-white hover:bg-red-700 focus:outline-none my-1"
        >
          Delete
        </button>
      </div>
