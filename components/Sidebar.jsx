...
export default function Sidebar({ studentList }) {
  ...
  return (
    <div className="w-[80%] px-4 pt-4 md:h-screen overflow-auto ">
      <div className="mx-auto w-full max-w-md rounded-2xl bg-white p-2">
        <Link href="/new-student">
          <div className="pl-1 hover:bg-gray-600 transition-[0.3s] p-2 rounded-md cursor-pointer hover:shadow-lg ">
            <h3 className="text-gray-800 hover:text-white font-bold text-[24px]">
              New Student
            </h3>
          </div>
        </Link>
          ...
          {({ open }) => (
            <>
              ...
              <Disclosure.Panel className="px-4 pt-4 pb-2 text-sm text-gray-500">
                <Link
                  href="/students"
                  className="p-2 ml-4 my-8 w-full transition-[0.3] border border-orange-300 hover:bg-orange-500 rounded-md group cursor-pointer hover:shadow-lg  hover:text-white font-semibold  "
                >
                      ...
                      <>
                        ...
                        <Disclosure.Panel className="flex flex-col justify-start items-end border-b-2 border-orange-500 mb-2">
                          <Link
                            ...
                            className=" p-2 ml-10 mb-8 w-full border transition-[0.3s] border-orange-300 hover:bg-orange-500 rounded-md group cursor-pointer hover:shadow-lg  hover:text-white font-semibold  "
                          >
                            View All (
                            {
                              studentList.filter(
                          ...
                          {studentList
                            ...
                            .map((student) => (
                              <Link
                                ...
                                className=" p-2 ml-10 mb-2 w-full border transition-[.3] border-orange-300 hover:bg-orange-500 rounded-md group cursor-pointer hover:shadow-lg  hover:text-white font-semibold  "
                              >
                                {student.fullname}
                              </Link>
                            ))}
